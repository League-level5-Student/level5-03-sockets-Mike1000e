   ...
   public static void main(String [] args) {
    ...
    try {
    	 //4. Create an object of the Socket class. When initializing the object, pass in the ip address and the port number
    		Socket obj = new Socket(ip, portNum);
         ...
         DataOutputStream stream = new DataOutputStream(obj.getOutputStream());
         ...
         DataInputStream inStream = new DataInputStream(obj.getInputStream());
